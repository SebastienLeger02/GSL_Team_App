<template>
  ...
  <div v-else>
    <Navbar />
    <section class="text-color-first bg-color-thirty pt-10">
      <section
      ...
      >
        ...
        <div>
          <section class="grid grid-cols-2 grid-rows-4 gap-6 max-w-md mx-auto">
            <div class="col-span-2">
              <h2
                class="text-2xl md:text-4xl font-bold text-center md:text-left"
              >
                {{ gameDetail?.title }}
              </h2>
            </div>
      ...
      <section class="mx-[12%]">
        <section class="bg-color-secondary p-[5%] mt-24 rounded-[25px]">
